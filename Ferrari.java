public final class Ferrari extends VeiculoMotorizado{        //Subclasse derivada de VeiculoMotorizado
	private final int quantPassos=10;
	private final float quantGasta=(float)1.5;

	public Ferrari(){
		super.setPassos(0);     //Seta a variavel passos usando um método da superclasse de qual ferrari deriva.
		super.setQuantRodas(4); //Seta a variavel quantRodas usando um método da superclasse de qual ferrari deriva.
		super.setTipo("F");     //Seta a variavel tipo usando um método da superclasse de qual ferrari deriva.
	...
	@Override
	public void print(){  //Utiliza os gets da superclasse para informar seu nome, tipo, quantidade de rodas, quantidade de combustível e se estão calibradas.
		System.out.printf("\n Nome:F"+super.getId()+"   Quantidade de rodas:"+super.getQuantRodas()+"   Quantidade de combustível:"+super.getComb());
		if(super.isRodasCalibr()==true)
